...
* 
* This block can be used either to measure timing between events, or 
* perform some action after a specified period of time.
* 
* The timer operation is highly configurable; see cyhal_timer_cfg_t.
*/
